    ...
    <script>
        ...
        var json = {
            <%
                ...
                Set<Map.Entry<String, String>> entries = statusForRateMap.entrySet();
        ...
        $(function () {
            ...
            $("#create-accountName").typeahead({
                source : function (query,process) {
                    $.get(
                        "transaction/getCustomerNameByLikeSearch.do",
                        {"name" : query},//$.trim($("#search").val())
                        function (data) {
                            process(data);
                        },
                        "json"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="btn-group" style="position: relative; top: 18%; left: 8px;">
                    <form class="form-inline" role="form">
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" style="width: 300px;" placeholder="请输入联系人名称，支持模糊查询" id="create-customerName">
                            <span class="glyphicon glyphicon-search form-control-feedback"></span>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-sm-10" style="width: 300px;">
            <select class="form-control" id="create-transactionOwner">
                <c:forEach var="user" items="${userList}">
                    <option value="${user.id}" ${user.id eq userInfo.id? "selected":""}>${user.name}</option>
                </c:forEach>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <select class="form-control" id="create-transactionStage" >
                <option></option>
                <c:forEach items="${stage}" var="eachstage">
