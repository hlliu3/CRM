        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div style="position: relative; left: 40px;">
                    姓名：<b>${userInfo.name}</b><br><br>
                    登录帐号：<b>${userInfo.loginAct}</b><br><br>
                    组织机构：<b>1005，市场部，二级部门</b><br><br>
                    邮箱：<b>${userInfo.email}</b><br><br>
                    失效时间：<b>${userInfo.expireTime}</b><br><br>
                    允许访问IP：<b>${userInfo.allowIps}</b>
                </div>
            </div>
            ...
            <li class="dropdown user-dropdown">
                <a href="javascript:void(0)" style="text-decoration: none; color: white;" class="dropdown-toggle"
                   data-toggle="dropdown">
                    <span class="glyphicon glyphicon-user"></span> ${userInfo.name} <span class="caret"></span>
                </a>
